...
const Header = () => {
  ...
  return (
    <div className="sticky  top-0 z-10 flex flex-row items-center justify-between h-[56px] px-4 md:px-5 bg-white dark:bg-black">
      {loading && <Loader />}
      ...
      <div className="flex items-center">
        <div className="hidden md:flex">
          ...
          <div className="flex bg-white h-8 w-8 overflow-hidden rounded-full cursor-pointer md:ml-4">
